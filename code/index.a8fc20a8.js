...
`,Jt=class extends ct{constructor(){super(...arguments);this.localize=new Mr(this)}render(){return ie`
    ...
    `}};Jt.styles=Nn;Jt=f([le("sl-spinner")],Jt);var Dn=Object.defineProperty,Ln=Object.getOwnPropertyDescriptor,ut=(e,t,r,o)=>{for(var n=o>1?void 0:o?Ln(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(n=(o?s(t,r,n):s(n))||n);return o&&n&&Dn(t,r,n),n};let K=class extends O{constructor(){super();this._time="",this._weekDays=["M\xE5ndag","Tisdag","Onsdag","Torsdag","Fredag","L\xF6rdag","S\xF6ndag"],this._today=new Date(new Date().getFullYear(),new Date().getMonth(),new Date().getDate()),this._foodSchedule=[],this.AddFoodSchedule(3),this._time=new Date().getHours()+":"+(new Date().getMinutes()<10?"0"+new Date().getMinutes():new Date().getMinutes()),setInterval(()=>{this._time=new Date().getHours()+":"+(new Date().getMinutes()<10?"0"+new Date().getMinutes():new Date().getMinutes())},1e3)}static get styles(){return[te`
        .page-container {
          display: block;
          width: 100%;
          height: 100%;
...
//# sourceMappingURL=index.a8fc20a8.js.map
